...
% using the explicit euler method
options = struct('step_control',false, 'initialStepSize', false);
[X1,T1,function_calls4,hs1,rs4] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler",options);
hs4 = hs1;
h = 0.01;
% using the explicit euler method
options = struct('step_control',false, 'initialStepSize', false);
[X2,T2,function_calls5,hs2,rs5] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler",options);
hs5 = hs2;

h = 0.001;
% using the explicit euler method
options = struct('step_control',false, 'initialStepSize', false);
[X3,T3,function_calls6,hs3,rs6] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler",options);
hs6 = hs3;
...
[X1,T1,function_calls7,hs1,rs7] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler", options);
hs7 = hs1;
...
% using the explicit euler method
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X2,T2,function_calls8,hs2,rs8] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler", options);
hs8 = hs2;
...
% using the explicit euler method
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X3,T3,function_calls9,hs3,rs9] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler", options);
hs9 = hs3;
...
% using the explicit euler method
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X1,T1,function_calls10,hs1,rs10] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler", options);
hs10 = hs1;
...
% using the explicit euler method
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X2,T2,function_calls11,hs2,rs11] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler", options);
hs11 = hs2;
...
% using the explicit euler method
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X3,T3,function_calls12,hs3,rs12] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler", options);
hs12 = hs3;
...
% using the explicit euler method
options = struct('step_control',false, 'initialStepSize', false);
[X1,T1,function_calls66,hs66,rs66] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "Explicit Euler",options);
