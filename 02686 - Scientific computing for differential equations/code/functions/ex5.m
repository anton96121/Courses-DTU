...
% using the Classical Runge-Kuttamethod
...
sgtitle('Classical Runge-Kutta with fixed step size, $\mu = 3$','Interpreter','latex','FontSize',20) 
...
legend("Classical Runge-Kutta","ode45","ode15s",'NumColumns',3,'FontSize',16,'Interpreter','latex');
...
% using the Classical Runge-Kuttamethod
options = struct('step_control',false, 'initialStepSize', false);
[X1,T1,function_calls4,hs1,rs4] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4",options);
hs4 = hs1;
h = 0.01;
% using the Classical Runge-Kuttamethod
options = struct('step_control',false, 'initialStepSize', false);
[X2,T2,function_calls5,hs2,rs5] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4",options);
hs5 = hs2;

h = 0.001;
% using the Classical Runge-Kuttamethod
options = struct('step_control',false, 'initialStepSize', false);
[X3,T3,function_calls6,hs3,rs6] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4",options);
hs6 = hs3;
...
sgtitle('Classical Runge-Kutta with fixed step size, $\mu = 20$','Interpreter','latex','FontSize',20) 
...
[X1,T1,function_calls7,hs1,rs7] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4", options);
hs7 = hs1;
...
% using the Classical Runge-Kuttamethod
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X2,T2,function_calls8,hs2,rs8] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4", options);
hs8 = hs2;
...
% using the Classical Runge-Kuttamethod
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X3,T3,function_calls9,hs3,rs9] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4", options);
hs9 = hs3;
...
sgtitle('Classical Runge-Kutta with adaptive step size, $\mu = 3$','Interpreter','latex','FontSize',20) 
...
% using the Classical Runge-Kuttamethod
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X1,T1,function_calls10,hs1,rs10] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4", options);
hs10 = hs1;
...
% using the Classical Runge-Kuttamethod
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X2,T2,function_calls11,hs2,rs11] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4", options);
hs11 = hs2;
...
% using the Classical Runge-Kuttamethod
options = struct('step_control',true, 'initialStepSize',true,'control_type', "PID",'Rtol',Rtol,'Atol',Atol);
[X3,T3,function_calls12,hs3,rs12] = ODEsolver(@VanPol,[mu],h,t0,tend,x0, "RK4", options);
hs12 = hs3;
...
sgtitle('Classical Runge-Kutta with adaptive step size, $\mu = 20$','Interpreter','latex','FontSize',20) 
